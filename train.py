...
if __name__ == "__main__":
    ...
    es = tez.callbacks.EarlyStopping(monitor="valid_loss", model_path="MusicModel.bin")
    model.fit(
        train_dataset,
    ...
    model.save("MusicModel.bin")

    preds = model.predict(valid_dataset, batch_size=4, n_jobs=-1, device="cpu")
    for p in preds:
        print(p)